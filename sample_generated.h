...
#ifndef FLATBUFFERS_GENERATED_SAMPLE_ORG_APACHE_ARROW_FLATBUF_H_
#define FLATBUFFERS_GENERATED_SAMPLE_ORG_APACHE_ARROW_FLATBUF_H_
...
inline const char *EnumNameIntervalUnit(IntervalUnit e) {
  if (flatbuffers::IsOutRange(e, IntervalUnit_YEAR_MONTH, IntervalUnit_DAY_TIME)) return "";
  const size_t index = static_cast<size_t>(e);
...
#endif  // FLATBUFFERS_GENERATED_SAMPLE_ORG_APACHE_ARROW_FLATBUF_H_
